...
namespace KarzPlus.Business
{
	...
	public static class CarModelManager
	{
		...
		{
			return Search(new SearchCarModel { ModelId = modelId }).FirstOrDefault();
		}

		/// <summary>
		/// Loads All UnDeleted CarModels
		/// </summary>
		/// <returns>An IEnumerable set of CarModel entities</returns>
		public static IEnumerable<CarModel> LoadAll()
		{
			return Search(new SearchCarModel());
		}

		/// <summary>
		/// Determines if CarModel is Valid to Remove
		/// </summary>
		/// <param name="modelId" />
		/// <returns>True, if CarModel is valid to remove</returns>
		...
		/// <summary>
		/// Loads CarModels on MakeId
		/// </summary>
		/// <param name="makeId" />
		/// <returns>An IEnumerable set of CarModel entities</returns>
		public static IEnumerable<CarModel> LoadOnMakeId(int makeId)
		{
			return Search(new SearchCarModel { MakeId = makeId });
		}
