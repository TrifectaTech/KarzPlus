		...
		<telerik:RadGrid runat="server" ID="grdInventory" OnNeedDataSource="grdLocation_NeedDataSource"
			...
			<MasterTableView Name="Location" DataKeyNames="LocationId" AutoGenerateColumns="false"
				...
				<Columns>
					...
					<telerik:GridButtonColumn CommandName="Delete" Text="Delete" ButtonType="LinkButton" ConfirmDialogType="RadWindow"
						ConfirmText="Are you sure you want to delete this location?" ConfirmTitle="Deleting..." />
				...
				<EditFormSettings EditFormType="WebUserControl" UserControlName="~/Controls/LocationConfiguration.ascx" />
			</MasterTableView>
		</telerik:RadGrid>
